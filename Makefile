...
SOURCE = \
	...
	$(SRCDIR)/Graphics/OpenGLContext/GLSL/glsl_CombinerProgramBuilderAccurate.cpp \
	$(SRCDIR)/Graphics/OpenGLContext/GLSL/glsl_CombinerProgramBuilderCommon.cpp \
	$(SRCDIR)/Graphics/OpenGLContext/GLSL/glsl_CombinerProgramBuilderFast.cpp \
	...
	$(SRCDIR)/Graphics/OpenGLContext/GLSL/glsl_CombinerProgramUniformFactoryAccurate.cpp \
	$(SRCDIR)/Graphics/OpenGLContext/GLSL/glsl_CombinerProgramUniformFactoryCommon.cpp \
	$(SRCDIR)/Graphics/OpenGLContext/GLSL/glsl_CombinerProgramUniformFactoryFast.cpp \
